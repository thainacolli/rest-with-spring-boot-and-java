...
public class PersonController {
    ...
    @CrossOrigin(origins = {"http://localhost8080", "https://rest.com.br"})
    @PostMapping(consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML},
            produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
    @Operation(summary = "Adds a new Person",
            description = "Adds a new Person by passing in a JSON or YML representation of the person",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = @Content(schema = @Schema(implementation = PersonVO.class))
    ...
    @Operation(summary = "Updates a Person",
            description = "Updates a Person by passing in a JSON or YML representation of the person",
            tags = {"People"},
            responses = {
    ...
    @Operation(summary= "Deletes a Person",
            description = "Deletes a Person by passing a ID",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
